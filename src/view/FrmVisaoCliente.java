 ...
 * @author aelysson
 */
public class FrmVisaoCliente extends javax.swing.JFrame {

    /**
     * Creates new form frmvistacliente
     */
    public FrmVisaoCliente() {
        initComponents();
        mostrar("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVisaoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVisaoCliente().setVisible(true);
            }
        });
    }
